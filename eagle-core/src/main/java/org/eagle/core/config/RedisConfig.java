...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        //user信息缓存配置
        RedisCacheConfiguration userCacheConfiguration = RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofMinutes(30)).disableCachingNullValues().prefixKeysWith("eagle");
        //product信息缓存配置
        ...
        redisCacheConfigurationMap.put("eagle", userCacheConfiguration);
